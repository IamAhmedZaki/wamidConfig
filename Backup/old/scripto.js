            ...
            exterior: {
                ...
                dropdowns: {
                    plastic: {
                        ...
                        // "Wheel Arch Cladding": [
                        //     {
                        //         id: "plastic_2", image: "./Images/pholder.png", name: "Black", colors: [
                        //             { color: "#000000", name: "Black", id: "body-plastic-black" },
                        //             { color: "#CCCCCC", name: "Silver", id: "body-plastic-silver" },
                        //             { color: "#666666", name: "Dark Grey", id: "body-plastic-dark-grey" }
                        //         ]
                        //     }
                        // ],
                        // "Side Skirts": [
                        //     {
                        //         id: "plastic_3", image: "./Images/pholder.png", name: "Pearl White", colors: [
                        //             { color: "#FFFFFF", name: "Pearl White", id: "car-paint-pearl-white" },
                        //             { color: "#000000", name: "Jet Black", id: "car-paint-jet-black" },
                        //             { color: "#C0C0C0", name: "Metallic Silver", id: "car-paint-metallic-silver" }
                        //         ]
                        //     }
                        // ],
                        // "Rear Diffuser": [
                        //     {
                        //         id: "plastic_4", image: "./Images/pholder.png", name: "Graphite", colors: [
                        //             { color: "#333333", name: "Graphite", id: "front-bumper-graphite" },
                        //             { color: "#DDDDDD", name: "Light Grey", id: "front-bumper-light-grey" },
                        //             { color: "#000000", name: "Black", id: "front-bumper-black" }
                        //         ]
                        //     }
                        // ],
                        // "Door Handle Covers": [
                        //     {
                        //         id: "plastic_5", image: "./Images/pholder.png", name: "Xenon White", colors: [
                        //             { color: "#FFFF00", name: "Xenon White", id: "headlights-xenon-white" },
                        //             { color: "#87CEEB", name: "LED Blue", id: "headlights-led-blue" },
                        //             { color: "#FFD700", name: "Halogen Yellow", id: "headlights-halogen-yellow" }
                        //         ]
                        //     }
                        // ]
                    },
                        ...
                        "Main Front Grille": [
                            {
                                id: "grills_1", image: "./Images/pholder.png", name: "Silver", colors: [
                                    { color: "#C0C0C0", name: "Silver", id: "alloy-wheels-grills-silver" },
                                    { color: "#000000", name: "Black", id: "alloy-wheels-grills-black" },
                                    { color: "#FFD700", name: "Gold", id: "alloy-wheels-grills-gold" }
                                ]
                            }
                        ],
                        "Lower Bumper Grille": [
                    ...
                    paints: {
                        "Body Paint": [
                            {
                                id: "paints_1", image: "./Images/pholder.png", name: "Silver", colors: [
                        ...
                        // "Roof Paint": [
                        //     {
                        //         id: "paints_2", image: "./Images/pholder.png", name: "Black", colors: [
                        //             { color: "#000000", name: "Black", id: "roof-rack-paints-black" },
                        //             { color: "#CCCCCC", name: "Silver", id: "roof-rack-paints-silver" },
                        //             { color: "#8B4513", name: "Brown", id: "roof-rack-paints-brown" }
                        //         ]
                        //     }
                        // ],
                        // "Mirror Caps": [
                        //     {
                        //         id: "paints_3", image: "./Images/pholder.png", name: "Graphite", colors: [
                        //             { color: "#333333", name: "Graphite", id: "side-steps-paints-graphite" },
                        //             { color: "#DDDDDD", name: "Brushed Steel", id: "side-steps-paints-brushed-steel" },
                        //             { color: "#000000", name: "Matte Black", id: "side-steps-paints-matte-black" }
                        //         ]
                        //     }
                        // ],
                        // "Door Handles": [
                        //     {
                        //         id: "paints_4", image: "./Images/pholder.png", name: "Steel Grey", colors: [
                        //             { color: "#333333", name: "Steel Grey", id: "bull-bar-paints-steel-grey" },
                        //             { color: "#000000", name: "Black", id: "bull-bar-paints-black" },
                        //             { color: "#DDDDDD", name: "Chrome", id: "bull-bar-paints-chrome" }
                        //         ]
                        //     }
                        // ],
                        // "Bumper Paint": [
                        //     {
                        //         id: "paints_5", image: "./Images/pholder.png", name: "Red", colors: [
                        //             { color: "#FF0000", name: "Red", id: "tow-hook-paints-red" },
                        //             { color: "#000000", name: "Black", id: "tow-hook-paints-black" },
                        //             { color: "#FFFF00", name: "Yellow", id: "tow-hook-paints-yellow" }
                        //         ]
                        //     }
                        // ]
                    }
    ...
    `;
                    ...
                    item.querySelectorAll('.color-swatch').forEach(swatch => {
                        swatch.addEventListener("click", (e) => {
                            ...
                            console.log(`Selected color ${e.target.title} for option ${optionId}`);
                            this.iframe.contentWindow.postMessage(`${optionId}:${color}`, 'https://playcanv.as');
                        });
                    });
